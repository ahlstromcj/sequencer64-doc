...
%  \includegraphics[scale=0.75]{menu/midi-clock-4-devices-manual-1.png}
   ...
   \caption{MIDI Clock, Manual ALSA Option On (Condensed View)}
...
%  \includegraphics[scale=0.75]{menu/midi-clock-4-devices-manual-0.png}
   ...
   \caption{MIDI Clock, Manual ALSA Option Off (Condensed View)}
...
%  \includegraphics[scale=0.75]{menu/midi-input-4-devices-manual-1.png}
   ...
   \caption{MIDI Input, Manual ALSA Ports On (Condensed View)}
...
\end{figure}
   ...
   \begin{enumber}
      \item \textbf{JACK Transport mode}
      \item \textbf{JACK Start mode}
      \item \textbf{JACK Connect}
      \item \textbf{JACK Disconnect}
