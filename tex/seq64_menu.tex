...
\label{paragraph:seq64_menu_file_options_midi_clock}
   ...
   The following figure shows the result with the manual ALSA option of
...
\end{figure}
   ...
   \figureref{fig:seq64_menu_file_options_midi_clock_manual_0}.
...
\end{figure}
   ...
   note that some \textsl{Sequencer64} windows can use the ctrl-left-click
   as a middle click. 
