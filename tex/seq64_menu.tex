...
\label{subsubsec:seq64_menu_file_options}
   ...
   In the \textbf{Qt 5} version of \textsl{Sequencer64}, this
   menu item has been moved to
   \sectionref{subsubsec:qt_portmidi_qt5_edit_prefs}, and there are still a few
   configuration items to be represented in that new user interface.
   Please see that section.

   The \textbf{File / Options}
   dialog allows one to select which sequence gets the MIDI
...
\end{figure}
   ...
   \begin{enumber}
      ...
      \item \textbf{Off}
      \item \textbf{Port Disabled}  (new with 0.95)
      \item \textbf{On (Pos)}
      \item \textbf{On (Mod)}
