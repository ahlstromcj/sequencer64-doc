...
%  \figureref{fig:seq64_menu_file_items}.
...
%  \includegraphics[scale=0.75]{new/menu_file.png}
   \includegraphics[scale=0.65]{new/menu_file_0_96.png}
...
\label{subsubsec:seq64_menu_file_import}
   ...
   \sectionref{subsec:seq64_midi_export_file_import}.
...
\label{subsubsec:seq64_menu_file_export}
   ...
   This functionality is explained in detail in
   \sectionref{subsec:seq64_midi_export_file_export}.
...
\label{subsubsec:seq64_menu_file_export_midi_only}
   ...
   This functionality is explained in detail in
   \sectionref{subsec:seq64_midi_export_file_export_midi_only}.
...
%  \includegraphics[scale=0.75]{new/midi-clock-4-devices-manual-1.png}
   \includegraphics[scale=0.65]{jack/jack-nano-yosh-manual-clock-seq64.png}
...
%  The \textbf{Sequencer64 Options} section contains a couple of new options.
