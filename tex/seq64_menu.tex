...
%  \includegraphics[scale=1.00]{menu/menu_file.png}
   \includegraphics[scale=1.00]{new/menu_file.png}
...
\end{figure}
   ...
   \begin{enumber}
      ...
      \item \textbf{Slot Shift}.
         Key: \index{keys!slash} \textbf{slash}.
   ...
   However, note that the mute-group keys will work only when
...
% marked by "itempar".
   ...
   \begin{enumber}
      ...
      \item \textbf{Song Record}
         Key: \index{keys!P} \textbf{P}.
      \item \textbf{One-shot Queue}
         Key: \index{keys!p} \textbf{p}.  This new feature allows
         one-shot queuing of a pattern.
   \end{enumber}
