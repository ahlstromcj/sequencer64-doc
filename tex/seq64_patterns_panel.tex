...
\label{sec:seq64_patterns_panel}
   ...
   \index{live mode}
   When the Patterns Panel has the application focus, and \textsl{Sequencer64}
   ...
   If \textsl{Sequencer64} is using JACK transport, then, Instead of the
   behavior described above, live versus song mode is controlled by the JACK
   start mode option.  option?
...
%  because the editor that was brought up is closed.
%
%  WE STILL NEED TO CODE UP THE EVENT EDITOR FOR THIS FEATURE!!!
