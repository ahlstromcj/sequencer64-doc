...
\label{sec:seq64_patterns_panel}
   ...
   bottom panel.  Note that the \textsl{Sequencer64} main menu is discussed in
...
\end{figure}
   ...
   \index{rc file}
   \texttt{~/.config/sequencer64/sequencer64rc} or \texttt{~/.seq24rc} files.
...
\label{subsec:seq64_patterns_panel_main}
   ...
   loops can be supported by \textsl{Sequencer64}.
   \index{screen set}
