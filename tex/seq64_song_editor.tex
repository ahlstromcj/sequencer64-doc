...
\end{figure}
   ...
   pending version 0.9.11, as seen in the following
   figure:
...
\begin{figure}[H]
   ...
   \caption{Song Editor Window, Another New Feature}
   \label{fig:song_editor_window_another_new_feature}
\end{figure}

   We see an additional button that allows the whole song (except for
