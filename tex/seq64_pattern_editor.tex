...
\begin{figure}[H]
   ...
   \caption{Pattern Editor, Second Panel Items, Legacy}
...
\begin{figure}[H]
   ...
   \caption{Pattern Editor, Second Panel Items with Chord Button}
   \label{fig:pattern_editor_main_panel_items_chord}
\end{figure}
...
\end{figure}
   ...
   \begin{itemize}
      ...
      \item \index{mouse!ctrl-left-click}
         ...
         in other applications, which is initiated via the \texttt{Shift} key.
...
\end{figure}
   ...
   \itempar{Chord Selection}{pattern editor!chord selection}
   With \textsl{Sequencer64 v. 0.9.9.14}, the ability to insert chords with one
...
\end{figure}
   ...
   created, with the click note value as the base of the chord.
