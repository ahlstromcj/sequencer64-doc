...
\end{figure}
   ...
   \begin{enumber}
      ...
      \item \textbf{LFO} (if built with LFO support)
...
\end{figure}
   ...
   This feature is currently disabled by default, so might not be present in a
   distro's pre-compiled version.
...
\end{figure}
   ...
   \begin{enumber}
      ...
      \item \textbf{Phase}:
         Provides phase shift within a period of the LFO wave.
         A value of 1 is a phase shift of 360 degrees.
      \item \textbf{Wave Type}:
         Provides the kind of wave to use for the LFO:
         \begin{enumber}
