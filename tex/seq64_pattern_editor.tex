...
\end{figure}
   ...
   The feature has some quirks, and we have made it optional, and tightened
   it up so that it is applied globally and immediately upon loading the MIDI
   file.
...
\end{figure}
   ...
   will apply the same settings to that sequence.  This is a feature.
   The feature has some quirks, and we will later make it optional, and tighten
   it up so that it is applied globally and immediately upon loading the MIDI
   file.
