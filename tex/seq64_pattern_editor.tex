...
\end{figure}
   ...
   Not shown in this figure is the new \textbf{LFO} button in the bottom panel,
   but it is described later.
...
\end{figure}
   ...
   the "Free" option in the "Vol" menu option did not work.  This is fixed.
