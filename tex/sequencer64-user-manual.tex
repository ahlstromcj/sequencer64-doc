...
\title{Sequencer64 User Manual 0.9.15}
\author{Chris Ahlstrom \\
...
\begin{figure}[H]
   \centering 
   \includegraphics[scale=0.75]{Sequencer64-0_9_14.png}
\end{figure}
...
\label{sec:introduction}
   ...
   \cite{sequencer64}, through version 0.9.15,
...
\label{subsec:improvements}
   ...
   \begin{itemize}
      ...
      \item The pattern-transposing feature of \textsl{Stazed}'s \textsl{Seq32}
         project has been ported into \textsl{Sequencer64}.  It can be
         disabled at configure/build time, if desired.
