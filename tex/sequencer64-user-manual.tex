...
\title{Sequencer64 User Manual 0.9.12}
\author{Chris Ahlstrom \\
...
\label{sec:introduction}
   ...
   \cite{sequencer64},
   through version 0.9.12, dated approximately through May, 2016,
   using the latest commit from
   ...
   Version 0.9.12 adds a few features to make song editing more
