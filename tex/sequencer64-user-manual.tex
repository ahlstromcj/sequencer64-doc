...
\title{Sequencer64 User Manual 0.9.21}
\author{Chris Ahlstrom \\
...
\label{sec:introduction}
   ...
   \cite{sequencer64}, through version 0.9.21,
...
\label{subsec:introduction_seq64_vs_others}
   ...
   lean, and powerful.  It deserves to be a living project.  Thus, without
...
%           playback.
   ...
   JACK MIDI, a scripting language, for OSC (Open Sound Control), and for NSM
...
\end{figure}
   ...
   This is the new \textbf{Tap Tempo} button.
