...
\title{Sequencer64 User Manual 0.9.10-rc}
\author{Chris Ahlstrom \\
...
\label{sec:introduction}
   ...
   and now through 0.9.10, April 2016.
   ...
   version 0.9.9.18 and for 0.9.10 (pending),
   ...
   Version 0.9.10 adds a few features to make song editing slightly more
