...
\title{Sequencer64 User Manual 0.9.10.1-rc}
\author{Chris Ahlstrom \\
...
\label{sec:introduction}
   ...
   and now through 0.9.10.1, April 2016.
   ...
   version 0.9.9.18 and for 0.9.10.1 (pending),
   ...
   Version 0.9.10.1 adds a few features to make song editing slightly more
   ...
   \begin{itemize}
      ...
      \begin{itemize}
         ...
         \item Ability to use the Mod4/Super/Windows key to keep editing
            ...
            "gamer" laptops.
         \item Shift-Left-Click on a pattern slot, pattern name, or M (mute)
            area now toggles the status of all of the other active slots.
      \end{itemize}
      ...
      \item A pause feature has been added to ALSA-mode playback.  It works,
         but still has some minor quirks.
