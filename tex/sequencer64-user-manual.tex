...
\begin{figure}[H]
   \centering 
   \includegraphics[scale=0.80]{Sequencer64-0_9_9_10-b.png}
\end{figure}
...
\label{sec:introduction}
   ...
   \cite{sequencer64},
   through version 0.9.9.12, dated approximately through early January, 2016.
   However, the final version of the "events" branch has not yet been merged
   into the "master" branch, and so this document is a little ahead of the
   master branch at this time.  Grab the "events" branch to get the latest
   code, which still has some event-editor bugs!
