...
\label{subsec:improvements}
   ...
   \begin{itemize}
      ...
      \item Features from \textsl{Stazed}'s \textsl{Seq32} \cite{seq32} project.
         Some features can be disabled at configure/build time, if desired.
      \begin{itemize}
         \item The chord-generation of \textsl{Seq32}
            has been ported into \textsl{Sequencer64}.
         \item The pattern-transposing feature
            has been ported into \textsl{Sequencer64}.
         \item MIDI song export has been ported to \textsl{Sequencer64}.
