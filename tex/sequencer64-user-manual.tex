...
\title{Sequencer64 User Manual 0.9.13}
\author{Chris Ahlstrom \\
...
\begin{figure}[H]
   \centering 
   \includegraphics[scale=0.75]{Sequencer64-0_9_11.png}
\end{figure}
...
\label{sec:introduction}
   ...
   Version 0.9.12 added a few features to make song editing more
   convenient for the author, who uses ALSA for basic work.
   There is now a Pause button and a configuration Pause
   keystroke, which defaults to a period (".").
   There are still a few minor quirks to the Pause feature...
   are they bugs of features?  Please send in any change-requests you feel you
   need!
   ...
   \begin{itemize}
      \item Tim Deagan (tdeagan): fixes to the mute-group support.
      \item 0rel: an important fix to properly add and relink notes after a
         paste action in the pattern editor.
      \item Stan Preston (stazed): ideas for some upcoming improvements based
   ...
   \begin{itemize}
      \item gimmeapill: testing, bug-reports, and, um, "marketing".
      \item muranyia: feature request for numbered piano keys and bug-reports.
      \item F0rth: a request for scripting support, a possible future feature.
      \item triss: a request for OSC support, a possible future feature.
      \item ssj71: a request for an LV2 plugin version, a possible future feature.
   \end{itemize}
...
\label{subsec:introduction_seq64_vs_others}
   ...
   session managers, better annunciation, uniformity, still more use of
   keystrokes, work-arounds for the need for two mouse buttons, a more
   up-to-date user-interface framework, some bug fixes, beefing up the support
...
\label{subsec:improvements}
   ...
   \begin{itemize}
      \item A new \textsl{event editor} dialog is now supported.
         ...
         once.  This editor is still a work-in-progress, but quite useful.
